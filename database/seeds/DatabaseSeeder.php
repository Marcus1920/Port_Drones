...
class DatabaseSeeder extends Seeder
{
    ...
    # =========================================================================
        ...
        $affiliations = [
            ['name' => 'Siyaleader','slug' => 'Siyaleader']
        ...
        $departments = [
            ['name' => 'Siyaleader','slug' => 'Siyaleader','acronym' => 'Siyaleader']
        ...
        # =========================================================================
        # USERS STATUSES SEEDS
        # =========================================================================


        DB::table('users_statuses')->truncate();

        $users_statuses = [
            ['name' => 'active','slug' => 'active'],
            ['name' => 'pre-reg','slug' => 'pre-reg']

        ];

        foreach ($users_statuses as $users_status) {
            UserStatus::create($users_status);
        }
