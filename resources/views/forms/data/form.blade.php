    ...
    <div class="modal-dialog">
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="hiddenn" style="">
            formId {!! Form::text('formId',NULL,['class' => 'form-control input-sm','id' => 'formId','style'=>"display: inline; width: auto"]) !!}
            id {!! Form::text('id',NULL, ['class' => 'form-control input-sm', 'id'=>"formDataId",'style'=>"display: inline; width: auto"]) !!}
            AJAX{!! Form::text('ajax',NULL, ['class' => 'form-control input-sm', 'id'=>"formAjax",'style'=>"display: inline; width: auto"]) !!}
                </div>
            	<div class="fields" style="height: 85%; overflow-x: hidden; overflow-y: auto;">
                  AJAX2{!! Form::text('ajax2',NULL, ['class' => 'form-control input-sm', 'id'=>"formAjax2"]) !!}
              </div>
            </div>
