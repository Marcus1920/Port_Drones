                                            ...
                                            <div class="row">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('first_name',isset($userOrder) ? $userOrder->name : '',['class' => 'form-control input-sm','id' => 'first_name','readonly']) !!}
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('Surname',isset($userOrder) ? $userOrder->surname : '',['class' => 'form-control input-sm','id' => 'Surname','readonly']) !!}
                                                            <div id = "hse_error_cellphone"></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('email',isset($userOrder) ? $userOrder->email : '',['class' => 'form-control input-sm','id' => 'email','readonly']) !!}
                                                            <div id = "hse_error_cellphone"></div>
                                                    ...
                                                    <div class="form-group">
                                                        ...
                                                        <div class="col-md-8">
                                                            {!! Form::text('cellphone',isset($userOrder) ? $userOrder->cellphone : '',['class' => 'form-control input-sm','id' => 'cellphone','readonly']) !!}
                                                            <div id = "hse_error_cellphone"></div>
                                                    ...
                                                    <div class="form-group">
                                                        <div class="col-md-8">
                                                            {!! Form::hidden('user',isset($userOrder) ? $userOrder->id : '',['class' => 'form-control input-sm','id' => 'user']) !!}
                                                            <div id = "hse_error_cellphone"></div>
