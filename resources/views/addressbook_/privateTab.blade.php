                    ...
                    <table class="table table-hover table-bordered results" id="myPrivateTable" >
                        ...
                        @foreach($contactBook as $privateContact)
                            <tr class="clickable-private">
                                ...
                                <td>
                                    <a class="t-overflow" onclick="profilePrivate({{$privateContact->user ? $privateContact->user : -1}});">
                ...
                <form class="form-horizontal" role="form" id="profileForm">
                    ...
                    <div class="col-md-8">
                        ...
                        <div class="form-group col-md-18">
                            ...
                            <div class="col-sm-9">
                                <input type="first_name" class="form-control" id="name" readonly value="{{ isset($privateContact) && is_object($privateContact->user) ? $privateContact->user->name : ''}}">
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9" >
                                <input type="Surname" class="form-control" id="surname"  value="{{  isset($privateContact) && is_object($privateContact->user) ? $privateContact->user->surname : '' }}"readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="dob" class="form-control" id="dob_private"  value="{{  isset($privateContact) && is_object($privateContact->user) ? $privateContact->user->dob : ''}}" readonly>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-9">
                                <input type="email" class="form-control" id="email_address"  value="{{ isset($privateContact) && is_object($privateContact->user)  ? $privateContact->user->email : ''}}" readonly>
                            </div>
                        </div>
                        <div class="form-group">
                            <label for="inputPassword3" class="col-sm-3 control-label">
                            ...
                            <div class="col-sm-9">
                                <input type="cellphone" class="form-control" id="cellphone" value="{{ isset($privateContact) && is_object($privateContact->user) ? $privateContact->user->cellphone : '' }}" readonly >
                            </div>
                        </div>
